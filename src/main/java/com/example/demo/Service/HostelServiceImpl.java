...
public class HostelServiceImpl implements HostelService {
	...
	public void addHostel(HostelDto hostelDto) {
		...
		if(hostelDto.getAddress().equals(null)) {
		throw new HostelServiceException("Address is Null", HttpStatus.BAD_REQUEST);
		}
...
//	}
	...
	@Override
	public List<Integer> getSharingTypes(int hostelId) {
		// TODO Auto-generated method stub

		return roomRespository.getSharingTypes(hostelId);
	}
